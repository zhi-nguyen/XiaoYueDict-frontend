...
export default function ExamListEn({
  groupedData,
  activeSubLevels,
  setActiveSubLevels,
  examStates,
    ...
    <div className="w-full p-6 md:p-8 pb-16">
      <div className="max-w-[1280px] mx-auto">
        <div className="flex justify-between items-center mb-8 border-b border-outline/30 pb-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-extrabold text-[#1d2b3e] font-lexend tracking-tight">
              Luyện Thi IELTS
            </h1>
            <p className="text-sm text-on-surface-variant font-medium mt-1 font-inter">
              Đề thi thử IELTS chuẩn khảo thí quốc tế đầy đủ kỹ năng
            </p>
          </div>
        </div>
        ...
        {categories.map((category) => {
          ...
          return (
            <div
              key={category}
              className="mb-12 bg-white border border-outline/70 rounded-[2rem] p-6 shadow-sm hover:shadow-md transition-shadow duration-300 relative overflow-hidden"
            >
              {/* Decorative top strip matching IELTS Indigo theme */}
              ...
              <div className="flex justify-between items-center mb-6 pb-3 border-b border-outline/30">
                ...
                <span className="text-xs font-semibold text-on-surface-variant bg-[#6366F1]/5 px-3 py-1 rounded-full font-inter">
